...
exports.loadImageClassification = exports.ImageClassificationModel = void 0;
...
var ImageClassificationModel = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        scores = (0, tfjs_core_1.tidy)(function () {
    ...
    ImageClassificationModel.prototype.preprocess = function (input, options) {
        ...
        var img = (0, util_1.imageToTensor)(input);
        var croppedImg = options.centerCrop ?
            centerCropAndResize(img) :
            (0, tfjs_core_1.expandDims)(tfjs_core_1.image.resizeBilinear(img, IMG_SIZE));
        return (0, tfjs_core_1.sub)((0, tfjs_core_1.div)(croppedImg, DIV_FACTOR), SUB_FACTOR);
    };
...
function centerCropAndResize(img) {
    return (0, tfjs_core_1.tidy)(function () {
        ...
        var boxIndices = [0];
        return tfjs_core_1.image.cropAndResize(
        // tslint:disable-next-line
        (0, tfjs_core_1.expandDims)((0, tfjs_core_1.cast)(img, 'float32')), boxes, boxIndices, IMG_SIZE);
    });
}
